...
diff -b --unified -Nr  qt-everywhere-opensource-src-$VERSION-orig  qt-everywhere-opensource-src-$VERSION > qt5-$VERSION-gcc-4.9.2.patch

mv qt5-$VERSION-gcc-4.9.2.patch ../patches
