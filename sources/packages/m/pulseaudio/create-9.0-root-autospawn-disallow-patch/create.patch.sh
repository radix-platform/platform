...
diff -b --unified -Nr  pulseaudio-$VERSION-orig  pulseaudio-$VERSION > pulseaudio-$VERSION-root-autospawn-disallow.patch

mv pulseaudio-$VERSION-root-autospawn-disallow.patch ../patches
