...
diff -b --unified -Nr  xf86-video-v4l-$VERSION-orig  xf86-video-v4l-$VERSION > xf86-video-v4l-$VERSION-v4l2-only.patch

mv xf86-video-v4l-$VERSION-v4l2-only.patch ../patches
