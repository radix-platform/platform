...
diff -b --unified -Nr  pulseaudio-$VERSION-orig  pulseaudio-$VERSION > pulseaudio-$VERSION-root-autospawn-allow.patch

mv pulseaudio-$VERSION-root-autospawn-allow.patch ../patches
