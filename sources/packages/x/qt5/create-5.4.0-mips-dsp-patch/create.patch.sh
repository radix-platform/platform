...
diff -b --unified -Nr  qt-everywhere-opensource-src-$VERSION-orig  qt-everywhere-opensource-src-$VERSION > qt5-$VERSION-mips-dsp.patch

mv qt5-$VERSION-mips-dsp.patch ../patches
