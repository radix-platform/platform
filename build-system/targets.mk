...
ifeq ($(BUILD_OMAP5EVM),)
COMPONENT_TARGETS := $(filter-out $(TARGET_OMAP5EVM),$(COMPONENT_TARGETS))
OMAP543X_EGLIBC_HARDWARE_VARIANTS := $(filter-out $(TARGET_OMAP5EVM),$(OMAP543X_EGLIBC_HARDWARE_VARIANTS))
endif
ifeq ($(BUILD_B74),)
...
ifeq ($(filter $(TARGET_OMAP5EVM),$(COMPONENT_TARGETS)),)
OMAP543X_EGLIBC_HARDWARE_VARIANTS := $(filter-out $(TARGET_OMAP5EVM),$(OMAP543X_EGLIBC_HARDWARE_VARIANTS))
endif
...
ifeq ($(TOOLCHAIN),$(X86_64_TOOLCHAIN_NAME))
LIBSUFFIX ?= 64
endif

__lib_dir = $(ROOTFS_DEST_DIR)/usr/lib$(LIBSUFFIX)
...
ifeq ($(HARDWARE),$(TARGET_OMAP5EVM))
ARCH_FLAGS += -D__TARGET__=$(TARGET_ID_OMAP5EVM)
endif
endif
...
ifneq ($(filter $(OMAP543X_EGLIBC_TOOLCHAIN_NAME),$(COMPONENT_TOOLCHAINS)),)
ARCH_FLAGS += -DOMAP5EVM=$(TARGET_ID_OMAP5EVM)
endif
...
# Compilation flags
COMMON_FLAGS = $(INCPATH) -g $(OPTIMIZATION_FLAGS) $(ARCH_FLAGS)
