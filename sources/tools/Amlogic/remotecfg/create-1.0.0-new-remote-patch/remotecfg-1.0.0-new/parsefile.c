...
extern unsigned short adc_map[MAX_ADC_CODES];
    ...
    while (fgets(line_data_buf, CC_MAX_LINE_LEN, fp)) {
        ...
        case KEYMAP_LEVEL:
            ...
            if (keycode) {
                ...
                printf("KEYMAP_LEVEL: ircode = 0x%02x, keycode = %u\n", ircode, keycode);
            }
            continue;
        case REPEATKEYMAP_LEVEL:
            ...
            if (keycode) {
                ...
                printf("REPEATKEYMAP_LEVEL: ircode = 0x%02x, keycode = %u\n", ircode, keycode);
            }
            continue;
        case MOUSEMAP_LEVEL:
            ...
            printf("MOUSEMAP_LEVEL: index = %d, ircode = 0x%02x\n", ircode, keycode);
            continue;
        case ADCMAP_LEVEL:
		...
		case FACTORYCUSTMAP_LEVEL:
            ...
            printf("FACTORYCUSTMAP_LEVEL: index = %d, custcode = 0x%04x\n", index, custcode);
            continue;
        }
    }
    return 0;
