...
contains(QT_ARCH, "mips") {
    ...
    MARCH = $$extractCFlag("-march=.*")
    !isEmpty(MARCH) {
        contains(QMAKE_CFLAGS, "-march=mips32r6"): GYP_CONFIG += mips_arch_variant=\"r6\"
        else: contains(QMAKE_CFLAGS, "-march=mips32r5"): GYP_CONFIG += mips_arch_variant=\"r5\"
        else: contains(QMAKE_CFLAGS, "-march=p5600"): GYP_CONFIG += mips_arch_variant=\"r5\"
        else: contains(QMAKE_CFLAGS, "-march=mips32r2"): GYP_CONFIG += mips_arch_variant=\"r2\"
        else: contains(QMAKE_CFLAGS, "-march=mips32"): GYP_CONFIG += mips_arch_variant=\"r1\"
    } else {
        contains(QMAKE_CFLAGS, "mips32r6"): GYP_CONFIG += mips_arch_variant=\"r6\"
        else: contains(QMAKE_CFLAGS, "mips32r5"): GYP_CONFIG += mips_arch_variant=\"r5\"
        else: contains(QMAKE_CFLAGS, "p5600"): GYP_CONFIG += mips_arch_variant=\"r5\"
    ...
    MTUNE = $$extractCFlag("-mtune=.*")
    !isEmpty(MTUNE) {
        contains(MTUNE, "p5600") GYP_CONFIG += mips_tune=\"$$MTUNE\" mips_arch_variant=\"r5\"
        else: GYP_CONFIG += mips_tune=\"$$MTUNE\"
    }
