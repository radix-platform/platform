...
diff -b --unified -Nr  qt-everywhere-opensource-src-$VERSION-orig  qt-everywhere-opensource-src-$VERSION > qt5-$VERSION-webkit-aarch64.patch

mv qt5-$VERSION-webkit-aarch64.patch ../patches
