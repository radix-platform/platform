...
LUPDATE = $$shell_path($$top_builddir/../qttools/bin/lupdate) -locations relative -no-ui-lines -no-sort
LRELEASE = $$shell_path($$top_builddir/../qttools/bin/lrelease)
LCONVERT = $$shell_path($$top_builddir/../qttools/bin/lconvert)
