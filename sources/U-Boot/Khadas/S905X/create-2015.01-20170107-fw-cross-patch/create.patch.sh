...
diff -b --unified -Nr  u-boot-khadas-$VERSION-orig  u-boot-khadas-$VERSION > u-boot-khadas-$VERSION-fw-cross.patch

mv u-boot-khadas-$VERSION-fw-cross.patch ../patches
