...
diff -b --unified -Nr  libomxil-bellagio-$VERSION-orig  libomxil-bellagio-$VERSION > libomxil-bellagio-$VERSION-automake.patch

mv libomxil-bellagio-$VERSION-automake.patch ../patches
