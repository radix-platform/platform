...
diff -b --unified -Nr  sane-backends-$VERSION-orig  sane-backends-$VERSION > sane-backends-$VERSION-kodakaio.patch

mv sane-backends-$VERSION-kodakaio.patch ../patches
