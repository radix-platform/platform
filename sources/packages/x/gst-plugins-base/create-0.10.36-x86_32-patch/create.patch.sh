...
diff -b --unified -Nr  gst-plugins-base-$VERSION-orig  gst-plugins-base-$VERSION > gst-plugins-base-$VERSION-x86_32.patch

mv gst-plugins-base-$VERSION-x86_32.patch ../patches
