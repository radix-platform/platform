...
diff -b --unified -Nr  xf86-input-aiptek-$VERSION-orig  xf86-input-aiptek-$VERSION > xf86-input-aiptek-$VERSION-automake.patch

mv xf86-input-aiptek-$VERSION-automake.patch ../patches
