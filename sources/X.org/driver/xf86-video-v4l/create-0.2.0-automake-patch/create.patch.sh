...
diff -b --unified -Nr  xf86-video-v4l-$VERSION-orig  xf86-video-v4l-$VERSION > xf86-video-v4l-$VERSION-automake.patch

mv xf86-video-v4l-$VERSION-automake.patch ../patches
