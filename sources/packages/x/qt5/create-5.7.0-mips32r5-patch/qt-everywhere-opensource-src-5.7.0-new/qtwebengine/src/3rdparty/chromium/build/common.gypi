    ...
    'variables': {
      'variables': {
        ...
        'conditions': [
          ...
          # Set arch tune variant for MIPS platforms.
          ['target_arch=="mipsel"', {
            'mips_tune%': '',
          }],
                  ...
                  ['mips_arch_variant=="r5"', {
                    'conditions': [
                      ...
                      ['clang==1', {
                         'conditions': [
                          ['OS=="android"', {
                            'cflags': [ '-target mipsel-linux-android', '-march=mipsel', '-mcpu=mips32r5'],
                            'ldflags': [ '-target mipsel-linux-android', ],
                          }, {
                            'cflags': [ '-target mipsel-linux-gnu', '-march=mipsel', '-mcpu=mips32r5'],
                            'ldflags': [ '-target mipsel-linux-gnu', ],
                          }],
                         ],
                      }, { # clang==0
                        'cflags': ['-mips32r5', '-Wa,-mips32r5', ],
                      }],
                      ['mips_tune!=""', {
                        'cflags': ['-mtune=<(mips_tune)', '-Wa,-mtune=<(mips_tune)'],
                      }],
                    ],
                  }],
                  ['mips_arch_variant=="r2"', {
