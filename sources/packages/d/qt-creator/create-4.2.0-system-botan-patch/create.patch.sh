...
diff -b --unified -Nr  qt-creator-opensource-src-$VERSION-orig  qt-creator-opensource-src-$VERSION > qt-creator-$VERSION-system-botan.patch

mv qt-creator-$VERSION-system-botan.patch ../patches
