...
diff -b --unified -Nr  gst-plugins-base-$VERSION-orig  gst-plugins-base-$VERSION > gst-plugins-base-$VERSION-remove-playbin.patch

mv gst-plugins-base-$VERSION-remove-playbin.patch ../patches
