...
diff -b --unified -Nr  qt-creator-opensource-src-$VERSION-orig  qt-creator-opensource-src-$VERSION > qt-creator-$VERSION-botan-on-arm.patch

mv qt-creator-$VERSION-botan-on-arm.patch ../patches
