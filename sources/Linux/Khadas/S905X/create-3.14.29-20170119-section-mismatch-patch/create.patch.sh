...
diff -b --unified -Nr  linux-khadas-$VERSION-orig  linux-khadas-$VERSION > linux-khadas-$VERSION-section-mismatch.patch

mv linux-khadas-$VERSION-section-mismatch.patch ../patches
