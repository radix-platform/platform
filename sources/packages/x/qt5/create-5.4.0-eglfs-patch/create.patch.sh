...
diff -b --unified -Nr  qt-everywhere-opensource-src-$VERSION-orig  qt-everywhere-opensource-src-$VERSION > qt5-$VERSION-eglfs.patch

mv qt5-$VERSION-eglfs.patch ../patches
