...
diff -b --unified -Nr  libva-vdpau-driver-$VERSION-orig  libva-vdpau-driver-$VERSION > libva-vdpau-driver-$VERSION-glext.patch

mv libva-vdpau-driver-$VERSION-glext.patch ../patches
