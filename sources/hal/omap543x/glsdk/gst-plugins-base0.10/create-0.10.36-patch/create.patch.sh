...
diff -b --unified -Nr  gst-plugins-base-ti-$VERSION-orig  gst-plugins-base-ti-$VERSION > gst-plugins-base-ti-$VERSION.patch

mv gst-plugins-base-ti-$VERSION.patch ../patches
