...
diff -b --unified -Nr  libva-vdpau-driver-$VERSION-orig  libva-vdpau-driver-$VERSION > libva-vdpau-driver-$VERSION-pix-info.patch

mv libva-vdpau-driver-$VERSION-pix-info.patch ../patches
