...
diff -b --unified -Nr  qt-everywhere-opensource-src-$VERSION-orig  qt-everywhere-opensource-src-$VERSION > qt5-$VERSION-ffmpeg-no-armv6.patch

mv qt5-$VERSION-ffmpeg-no-armv6.patch ../patches
