...
diff -b --unified -Nr  qt-everywhere-opensource-src-$VERSION-orig  qt-everywhere-opensource-src-$VERSION > qt4-$VERSION-aarch64.patch

mv qt4-$VERSION-aarch64.patch ../patches
