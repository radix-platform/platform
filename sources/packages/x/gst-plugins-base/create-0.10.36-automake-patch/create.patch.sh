...
diff -b --unified -Nr  gst-plugins-base-$VERSION-orig  gst-plugins-base-$VERSION > gst-plugins-base-$VERSION-automake.patch

mv gst-plugins-base-$VERSION-automake.patch ../patches
